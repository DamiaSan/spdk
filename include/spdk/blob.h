...
/**
 * Set parent snapshot of a blob.
 *
 * This call change the parent of a blob, so this blob will become a clone of
 * a snapshot. Blob id must refear to a thin provisioned blob without snapshots,
 * snapshot id must refear to a snapshot blob. Blob and snapshot must have same dimensions.
 *
 * \param bs blobstore.
