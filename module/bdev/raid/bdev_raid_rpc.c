...
SPDK_RPC_REGISTER("bdev_raid_get_base_bdev_delta_map", rpc_bdev_raid_get_base_bdev_delta_map, SPDK_RPC_RUNTIME)
...
SPDK_RPC_REGISTER("bdev_raid_stop_base_bdev_delta_map", rpc_bdev_raid_stop_base_bdev_delta_map, SPDK_RPC_RUNTIME)
...
SPDK_RPC_REGISTER("bdev_raid_clear_base_bdev_faulty_state", rpc_bdev_raid_clear_base_bdev_faulty_state, SPDK_RPC_RUNTIME)
